"""
Django settings for bank_management_backend project.
...
SECRET_KEY = "django-insecure-irpg6-58ef(vnykg$tpzs0(ua8wn5-j#)%tzm(v=ndf_p!rko3"
...
WSGI_APPLICATION = "bank_management_backend.wsgi.application"
